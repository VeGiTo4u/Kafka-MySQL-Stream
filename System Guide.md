...
6.	Open five terminal instances, run the producer in one, the five consumers in the others, and verify that all consumers are receiving messages and saving them in their respective JSON files.
```
